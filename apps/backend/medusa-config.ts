...
module.exports = defineConfig({
  projectConfig: {
    ...
    http: {
      ...
      jwtSecret: process.env.JWT_SECRET || "supersecret_jwt_key_sasa_by_sakshi_2026_secure_key_12345",
      cookieSecret: process.env.COOKIE_SECRET || "supersecret_cookie_key_sasa_by_sakshi_2026_secure_key_12345",
    },
  },
  modules,
})
